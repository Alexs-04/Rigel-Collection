    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/product/**", "/suppliers/**", "/batches/**")
                        .hasAnyRole("ROOT", "ADMIN", "USER", "SUPPLIER")
                        .requestMatchers(HttpMethod.POST, "/product/add", "/suppliers/add", "/batches/add")
                        .hasAnyRole("ROOT", "ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/product/**", "/suppliers/**", "/batches/**")
                        .hasAnyRole("ROOT", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/product/**", "/suppliers/**", "/batches/**")
                        .hasAnyRole("ROOT", "ADMIN")
